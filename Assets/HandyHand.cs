...
namespace Valve.VR.InteractionSystem
{
    ...
    //-------------------------------------------------------------------------
    public class HandyHand : MonoBehaviour
    {
        ...
        //-------------------------------------------------
        // The Interactable object this HandyHand is currently hovering over
        //-------------------------------------------------
        ...
        //-------------------------------------------------
        // Active GameObject attached to this HandyHand
        //-------------------------------------------------
        ...
        {
            Debug.Log("Tried to AttachObject");
        }
            /*
            //-------------------------------------------------
            ...
            // attachmentPoint - Name of the GameObject in the hierarchy of this HandyHand which should act as the attachment point for this GameObject
            //-------------------------------------------------
            public void AttachObject(GameObject objectToAttach, GrabTypes grabbedWithType, AttachmentFlags flags = defaultAttachmentFlags, Transform attachmentOffset = null)
            {
        ...
        //-------------------------------------------------
        // Detach this GameObject from the attached object stack of this HandyHand
        //
        // objectToDetach - The GameObject to detach from this HandyHand
        //-------------------------------------------------
        ...
        //-------------------------------------------------
        // Get the world velocity of the VR HandyHand.
        //-------------------------------------------------
        ...
        //-------------------------------------------------
        // Get the world space angular velocity of the VR HandyHand.
        //-------------------------------------------------
        ...
        protected virtual IEnumerator Start()
        {
            ...
            if (!playerInstance)
            {
                Debug.LogError("<b>[SteamVR Interaction]</b> No player instance found in HandyHand Start()", this);
            }

            if (this.gameObject.layer == 0)
                Debug.LogWarning("<b>[SteamVR Interaction]</b> HandyHand is on default layer. This puts unnecessary strain on hover checks as it is always true for hand colliders (which are then ignored).", this);
            else
            ...
            if (true)//noSteamVRFallbackCamera) //***
            {
                yield break;
            }

            //Debug.Log( "<b>[SteamVR Interaction]</b> HandyHand - initializing connection routine" );
        ...
        protected virtual bool CheckHoveringForTransform(Vector3 hoverPosition, float hoverRadius, ref float closestDistance, ref Interactable closestInteractable, Color debugColor)
        {
            ...
            if (numColliding >= ColliderArraySize)
                Debug.LogWarning("<b>[SteamVR Interaction]</b> This hand is overlapping the max number of colliders: " + ColliderArraySize + ". Some collisions may be missed. Increase ColliderArraySize on HandyHand.cs");
        ...
        private void HandDebugLog(string msg)
        {
            if (spewDebugText)
            {
                Debug.Log("<b>[SteamVR Interaction]</b> HandyHand (" + this.name + "): " + msg);
            }
        }


        //-------------------------------------------------
        // Continue to hover over this object indefinitely, whether or not the HandyHand moves out of its interaction trigger volume.
        //
        ...
        {
            if (spewDebugText)
                HandDebugLog("HandyHand " + name + " connected with type " + handType.ToString());
    ...
    [System.Serializable]
    public class HandEvent : UnityEvent<HandyHand> { }
}