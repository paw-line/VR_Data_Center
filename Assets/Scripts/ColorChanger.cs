...
public class ColorChanger : MonoBehaviour
{
    ...
    /** \brief Сопрограмма-таймер, отвечающая за регулярное обновление температуры и цвета объекта в соотвествии с данными источника.
     ...
     * После этого производится ожидание на время обновление до повторения цикла. 
     */
